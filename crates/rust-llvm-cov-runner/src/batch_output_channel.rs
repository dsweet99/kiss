...
pub(crate) use crate::batch_output_channel_frame::{read_frame, write_frame};
use crate::batch_output_channel_token::{
...
pub(crate) fn read_connection_frames(
    ...
    loop {
        ...
        if config.relay_live {
            crate::batch_output_channel_frame::relay_frame_live(&frame);
        }
        frames
            .lock()
            .expect("output channel frames lock")
