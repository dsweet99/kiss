...
pub(crate) fn build_instance_results(
    started_tests: &[crate::execute_or_reuse::batch_events::BatchTestStarted],
    ignored_tests: &[crate::execute_or_reuse::batch_events::BatchTestStarted],
    terminal_tests: &[crate::execute_or_reuse::batch_events::BatchTestTerminal],
...
pub(crate) fn build_instance_export_requests(
    ...
    shim_metadata: &[BatchShimMetadata],
    artifacts: &[crate::execute_or_reuse::batch_events::BatchCompilerArtifact],
...
pub(crate) fn finish_fresh_batch_after_export(
    ...
    export_counters: crate::execute_or_reuse::batch_export::ExportCounters,
...
fn reject_missing_terminal_events(
    ...
    let ignored_names: BTreeSet<_> =
        if crate::execute_or_reuse::batch_events::rust_test_args_include_ignored(&req.test_args) {
            BTreeSet::new()
        } else {
            ignored_tests
                .iter()
