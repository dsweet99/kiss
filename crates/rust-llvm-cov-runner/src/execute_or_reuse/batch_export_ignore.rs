...
use crate::plan::cargo_workspace_metadata::{WorkspacePackage, load_cargo_metadata};
...
#[cfg(test)]
use crate::plan::cargo_workspace_metadata::CargoMetadata;

#[cfg(test)]
pub(crate) use crate::plan::cargo_workspace_metadata::{
