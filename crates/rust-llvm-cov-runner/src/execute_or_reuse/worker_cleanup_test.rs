...
use crate::execute_or_reuse::worker::{
...
fn worker_tmp_parent_and_digest_helpers_are_stable() {
    ...
    let digest = crate::execute_or_reuse::worker::cache_root_digest(&cache_root);
    assert_eq!(digest.len(), 64);
    let attempt = crate::execute_or_reuse::worker::RustLegacyCleanupAttempt { deferred: false };
