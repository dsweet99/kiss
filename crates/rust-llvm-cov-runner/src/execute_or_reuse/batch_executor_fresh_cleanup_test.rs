...
use crate::execute_or_reuse::batch_executor_fresh::{
...
fn reject_nonzero_without_terminal_events_direct_witness() {
    use crate::execute_or_reuse::batch_events::BatchEventStream;
    use crate::execute_or_reuse::batch_run::BatchSubprocessRunOutcome;
    ...
    let ok_terminal = reject_nonzero_without_terminal_events(
        ...
        &BatchEventStream {
            terminal_tests: vec![crate::execute_or_reuse::batch_events::BatchTestTerminal {
