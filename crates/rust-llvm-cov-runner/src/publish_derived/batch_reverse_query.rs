...
#[cfg(test)]
pub use crate::publish_derived::batch_reverse_query_metrics::reset_reverse_query_counters_for_test;
...
fn load_validated_record(
    root: &Path,
    rel: &str,
    file_meta: &crate::publish_derived::batch_reverse_build::FileMeta,
