...
pub fn write_identity_mtime_seal(
    ...
    let seal = InputMtimeSeal {
        ...
        source_root: crate::batch_derived_index::normalized_source_root(source_root),
...
pub fn try_identity_from_mtime_seal(
    ...
    if seal.source_root != crate::batch_derived_index::normalized_source_root(source_root) {
        return None;
    }
    ...
    let live_generation = crate::batch_fingerprint::generation_fingerprint(
        &seal.input_digest,
        req,
        tools,
