...
use crate::batch_export::FakeInstanceExporter;
use crate::batch_fingerprint::batch_identity;
use crate::batch_plan::build_rust_coverage_batch_plan;
use crate::batch_run::{BatchSubprocessRunner, CurrentRunCleanup, prepare_batch_run_layout};
...
fn reject_nonzero_without_terminal_events_direct_witness() {
    use crate::batch_events::BatchEventStream;
    use crate::batch_run::BatchSubprocessRunOutcome;
    ...
    let ok_terminal = reject_nonzero_without_terminal_events(
        ...
        &BatchEventStream {
            terminal_tests: vec![crate::batch_events::BatchTestTerminal {
...
fn interrupted_batch_attempts_current_run_cleanup() {
    ...
    let runner = BatchSubprocessRunner::from_fn(|_, _| {
        Err(crate::batch_run::BatchSubprocessRunError::Spawn {
