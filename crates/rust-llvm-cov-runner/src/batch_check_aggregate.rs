...
pub(crate) use crate::batch_check_aggregate_export::{
    build_check_aggregate_export_requests, export_check_aggregates_bounded,
};
use crate::batch_check_aggregate_identity::{
...
use crate::batch_derived_index::normalized_source_root;
...
pub(crate) fn selector_binary_ids_from_outcomes(
    outcomes: &[crate::RustLlvmCovOutcome],
...
pub fn reusable_check_aggregate_delta(
    ...
    crate::batch_derived_index::reusable_snapshot_delta(source_root, prior, current)
}
