...
pub(crate) fn try_warm_all_hit_seal(
    ...
    let entry_state = crate::batch_entry_state::read_entry_state(&req.cache_root)?;
...
pub(crate) fn write_warm_all_hit_seal(
    ...
    let entry_state = crate::batch_entry_state::read_entry_state(&req.cache_root).ok_or_else(|| {
