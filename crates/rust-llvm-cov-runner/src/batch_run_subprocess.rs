...
mod tests {
    ...
    use crate::batch_process_tree::{BatchProcessTreeGuard, ProcessGroupIdentity, record_child_process_group};
    ...
    fn ingest_live_shim_identities_records_each_identity_once() {
        ...
        for _ in 0..2 {
            ...
            let mut child = guard.spawn_batch_command(&mut command).expect("spawn child");
