...
6. User-facing workflows: actions such as checking the repo, showing stats, visualizing dependencies, moving symbols, generating or inspecting configuration, detecting duplicates, running covering tests (including `--watch`), and evaluating coverage alone.
