...
4. Quality measurement: maintainability signals such as complexity, size, duplication, test references, coverage relationships, and rule violations.
...
6. User-facing workflows: actions such as checking the repo, showing stats, visualizing dependencies, shrinking constraints, moving symbols, generating or inspecting configuration, detecting duplicates, running covering tests (including `--watch`), and evaluating coverage alone.
