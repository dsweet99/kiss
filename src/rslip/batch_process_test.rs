use super::*;
use crate::rpytest_runner::{PytestRunOutcome, PytestRunner, TestStatus};
...
fn configure_two_process_contention_child<'a>(
    ...
    command
        .arg("--exact")
        .arg("rslip::batch_process_test::two_process_same_host_cold_cache_contention_prefers_first_store")
        .arg("--nocapture")
