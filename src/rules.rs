...
const PY_RULE_SPECS: &[RuleSpec] = &[
    ...
    RuleSpec { metric: "calls_per_function", op: "<", threshold: ThresholdValue::Usize(|c, _| c.calls_per_function), description: "calls_per_function is the maximum number of function/method calls in a Python function." },
    ...
    RuleSpec { metric: "functions_per_file", op: "<", threshold: ThresholdValue::Usize(|c, _| c.functions_per_file), description: "functions_per_file is the maximum number of functions/methods defined in a Python file." },
...
const RS_RULE_SPECS: &[RuleSpec] = &[
    ...
    RuleSpec { metric: "calls_per_function", op: "<", threshold: ThresholdValue::Usize(|c, _| c.calls_per_function), description: "calls_per_function is the maximum number of function/method calls in a Rust function." },
    ...
    RuleSpec { metric: "functions_per_file", op: "<", threshold: ThresholdValue::Usize(|c, _| c.functions_per_file), description: "functions_per_file is the maximum number of functions/methods defined in a Rust file." },
