...
pub(super) const PY_RULE_SPECS: &[RuleSpec] = &[
    ...
    RuleSpec {
        ...
        description: "annotations_per_function counts Python decorators on a function.",
    },
    RuleSpec {
    ...
    RuleSpec {
        ...
        description: "imported_names_per_file is the maximum number of unique imported names in a Python file (excluding TYPE_CHECKING-only imports). `__init__.py` is exempt from this gate.",
    },
    RuleSpec {
        metric: "cycle_size",
        op: ThresholdOp::AtMost,
