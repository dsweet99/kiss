fn common_config_key_fn(metric_id: &str) -> Option<&'static str> {
    match metric_id {
...
fn common_config_key_file(metric_id: &str) -> Option<&'static str> {
    match metric_id {
...
fn common_config_key_graph(metric_id: &str) -> Option<&'static str> {
    match metric_id {
...
pub(crate) fn common_config_key(metric_id: &str) -> Option<&'static str> {
    common_config_key_fn(metric_id)
        ...
        .or_else(|| common_config_key_graph(metric_id))
}
