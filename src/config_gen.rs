...
mod tests {
    ...
    fn test_config_keys_and_generation() {
        ...
        append_shared_section(&mut out3, &[PercentileSummary { name: "Lines per file", count: 5, max: 500, p50: 100, p90: 200, p95: 250, p99: 300 }], &[PercentileSummary { name: "Lines per file", count: 5, max: 600, p50: 150, p90: 250, p95: 350, p99: 400 }]);
        assert!(out3.contains("lines_per_file = 400"));
    }
}
