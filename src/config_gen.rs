...
/// Collect Python statistics from a directory, with ignore prefixes
...
/// Collect Rust statistics from a directory, with ignore prefixes
...
/// Collect stats from multiple paths, with ignore prefixes
