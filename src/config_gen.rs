...
mod tests {
    ...
    fn test_config_keys_and_generation() {
        ...
        let mut py_defaults = String::new();
        append_python_non_collected_defaults(&mut py_defaults);
        assert!(py_defaults.contains("statements_per_try_block") && py_defaults.contains("boolean_parameters"));
        let mut rs_defaults = String::new();
        append_rust_non_collected_defaults(&mut rs_defaults);
        assert!(rs_defaults.contains("boolean_parameters") && rs_defaults.contains("attributes_per_function"));
    }
}
