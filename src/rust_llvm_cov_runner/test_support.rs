...
#[cfg(test)]
pub(crate) fn witness_batch_tools() -> crate::rust_llvm_cov_runner::RustCoverageToolIdentity {
    crate::rust_llvm_cov_runner::RustCoverageToolIdentity {
...
pub(crate) struct PublishedAlphaFixture {
    ...
    pub req: crate::rust_llvm_cov_runner::RustCoverageBatchRequest,
    #[allow(dead_code)]
    pub tools: crate::rust_llvm_cov_runner::RustCoverageToolIdentity,
    pub identity: crate::rust_llvm_cov_runner::RustCoverageBatchIdentity,
}
...
#[cfg(test)]
pub(crate) fn shim_only_metadata(
    output: &Path,
