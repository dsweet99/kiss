...
#[cfg(test)]
use crate::rust_llvm_cov_runner::execute_or_reuse::batch_export::export_instances_bounded_with;
...
pub(crate) fn execute_fresh_batch_with_export_fn(
    ...
    plan: &RustCoverageBatchPlan,
    runner: &BatchSubprocessRunner,
    export_fn: crate::rust_llvm_cov_runner::execute_or_reuse::batch_export::BatchInstanceExportFn,
) -> Result<RustCoverageBatchResult, RustLlvmCovError> {
    execute_fresh_batch_with_cleanup(
        req,
        tools,
...
where
    E: FnOnce(
        ...
        &std::path::Path,
        &[std::path::PathBuf],
        Vec<crate::rust_llvm_cov_runner::execute_or_reuse::batch_export::InstanceExportRequest>,
    ) -> Result<
        (
            Vec<(String, crate::rust_llvm_cov_runner::RustLineCoverage)>,
            crate::rust_llvm_cov_runner::execute_or_reuse::batch_export::ExportCounters,
        ),
        RustLlvmCovError,
    >,
{
...
fn prepare_fresh_batch_run(
    ...
    crate::rust_llvm_cov_runner::plan::batch_runner_resolve::write_runner_map(
    ...
    let shim_metadata = match &req.coverage_output_mode {
        CoverageOutputMode::CheckAggregate { .. } => {
            ...
            let profile = crate::rust_llvm_cov_runner::execute_or_reuse::batch_shim_synthesize::check_aggregate_pool_profile_path_for_run(
                &plan.build_target,
                run_root,
            );
            crate::rust_llvm_cov_runner::execute_or_reuse::progress::log_named_step(
...
fn reject_failed_build_without_tests(
    run: &crate::rust_llvm_cov_runner::execute_or_reuse::batch_run::BatchSubprocessRunOutcome,
    parsed: &BatchEventStream,
...
pub(crate) fn reject_nonzero_without_terminal_events(
    run: &crate::rust_llvm_cov_runner::execute_or_reuse::batch_run::BatchSubprocessRunOutcome,
    parsed: &crate::rust_llvm_cov_runner::execute_or_reuse::batch_events::BatchEventStream,
) -> Result<(), RustLlvmCovError> {
