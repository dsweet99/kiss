...
use crate::rust_llvm_cov_runner::execute_or_reuse::batch_process_tree::ProcessGroupIdentity;
use crate::rust_llvm_cov_runner::plan::batch_runner_resolve::read_runner_map;
...
pub(crate) fn run_target_runner_shim_inner(
    ...
    crate::rust_llvm_cov_runner::kiss_profraw::redirect_inherited_llvm_profile_file(output_dir)?;
    ...
    let cleanup_err = crate::rust_llvm_cov_runner::kiss_profraw::cleanup_kiss_profraw_for_pid(
        &crate::rust_llvm_cov_runner::kiss_profraw::resolve_kiss_profraw(output_dir),
        std::process::id(),
    )
    .err();
...
fn run_delegated_child(
    ...
    #[cfg(unix)]
    {
        crate::rust_llvm_cov_runner::execute_or_reuse::batch_shim_delegated::release_delegated_child_handshake(&go_path)?;
    }
...
fn delegated_child_spawn(
    ...
    #[cfg(unix)]
    {
        crate::rust_llvm_cov_runner::execute_or_reuse::batch_shim_delegated::spawn_delegated_piped_child(
            delegated,
            command,
            profile_path,
            go_path,
