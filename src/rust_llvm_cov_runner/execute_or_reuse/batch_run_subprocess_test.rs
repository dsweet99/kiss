...
use crate::rust_llvm_cov_runner::execute_or_reuse::batch_shim::write_shim_start_metadata;
use crate::rust_llvm_cov_runner::execute_or_reuse::batch_shim_delegated::COVERAGE_BUILD_ENV_KEYS_FOR_TEST;
...
fn ingest_live_shim_identities_records_each_identity_once() {
    ...
    let registry = crate::rust_llvm_cov_runner::execute_or_reuse::batch_process_tree::ProcessTreeRegistry::default();
