...
mod tests {
    ...
    fn executable_index_rejects_missing_list_metadata() {
        ...
        let req = crate::rust_llvm_cov_runner::RustCoverageBatchRequest::witness();
        let mut plan = crate::rust_llvm_cov_runner::RustCoverageBatchPlan::witness();
    ...
    fn builds_executable_index_from_target_runner_list_metadata() {
        ...
        let binary_id =
            crate::rust_llvm_cov_runner::execute_or_reuse::batch_executor_finish::test_binary_id_for_path(&bin);
