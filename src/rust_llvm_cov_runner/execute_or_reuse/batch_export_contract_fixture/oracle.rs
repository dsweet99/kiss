...
use crate::rust_llvm_cov_runner::RustCoverageToolIdentity;
...
pub(crate) fn merge_profraws_for_test(
    tools: &crate::rust_llvm_cov_runner::execute_or_reuse::batch_export_tools::ExportTools,
    profraws: &[PathBuf],
    profdata_output: &Path,
) -> Result<(), crate::rust_llvm_cov_runner::RustLlvmCovError> {
