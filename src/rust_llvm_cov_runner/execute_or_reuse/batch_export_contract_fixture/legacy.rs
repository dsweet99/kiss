...
use crate::rust_llvm_cov_runner::execute_or_reuse::batch_export::object_paths_for_executable;
use crate::rust_llvm_cov_runner::execute_or_reuse::batch_shim::load_target_runner_shim_metadata;
use crate::rust_llvm_cov_runner::execute_or_reuse::llvm_cov_json::parse_llvm_cov_json_file;
use crate::rust_llvm_cov_runner::plan::batch_runner_resolve::resolve_batch_request_runners;
...
fn run_per_selector_cargo_llvm_cov_oracle(
    ...
    let coverage = if status == crate::rpytest_runner::TestStatus::Passed {
...
pub(crate) fn assert_outcomes_match(
    ...
    if legacy.status == crate::rpytest_runner::TestStatus::Failed {
