...
use crate::rust_llvm_cov_runner::execute_or_reuse::batch_process_tree::BatchScopeInterruptGuard;
use crate::rust_llvm_cov_runner::{RustLlvmCovError, batch_result::RustCoverageBatchResult};
...
impl FreshBatchRunScope {
    ...
    pub fn begin_with_layout(
        cache_root: &Path,
        plan: &crate::rust_llvm_cov_runner::plan::batch_plan::RustCoverageBatchPlan,
        cleanup: CurrentRunCleanup,
    ) -> io::Result<Self> {
        let run_root = plan
            .generated_config
