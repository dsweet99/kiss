...
use crate::rust_llvm_cov_runner::execute_or_reuse::llvm_cov_json::parse_llvm_cov_json;
use crate::rust_llvm_cov_runner::execute_rust_coverage_batch;

use crate::rust_llvm_cov_runner::batch_export_contract_fixture::*;
...
fn collect_legacy_outcomes(
    ...
    case: &ParityMatrixCase,
    test_args: &[String],
) -> BTreeMap<String, crate::rust_llvm_cov_runner::RustLlvmCovOutcome> {
    selectors
        .iter()
        .map(|selector| {
...
fn assert_parity_batch_result(
    ...
    selectors: &[String],
    legacy: &BTreeMap<String, crate::rust_llvm_cov_runner::RustLlvmCovOutcome>,
    batch_req: &crate::rust_llvm_cov_runner::RustCoverageBatchRequest,
    fixture_root: &Path,
) {
...
fn assert_diagnostic_exit_37(
    ...
    assert_eq!(outcome.status, crate::rpytest_runner::TestStatus::Failed);
...
fn assert_nocapture_live_output(
    _batch: &crate::rust_llvm_cov_runner::RustCoverageBatchResult,
    batch_req: &crate::rust_llvm_cov_runner::RustCoverageBatchRequest,
    debug: &str,
) {
    let metadata = shim_metadata_for_batch(batch_req);
...
fn shim_metadata_for_batch(
    ...
    crate::rust_llvm_cov_runner::execute_or_reuse::batch_shim::load_target_runner_shim_metadata(
        &batch_req
            .generated_config
            .parent()
            .expect("run root")
