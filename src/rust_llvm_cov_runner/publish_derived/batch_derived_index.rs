...
use crate::rust_llvm_cov_runner::publish_derived::batch_derived_index_reverse::reverse_bound_index_ok;
#[cfg(test)]
use crate::rust_llvm_cov_runner::publish_derived::batch_derived_index_types::OnDiskIndex;
use crate::rust_llvm_cov_runner::publish_derived::batch_derived_index_types::{
...
use crate::rust_llvm_cov_runner::rust_cov_cache::generation_entries_fingerprint;
use std::collections::{BTreeMap, BTreeSet};
use std::fs;
use std::path::{Path, PathBuf};

pub(crate) use crate::rust_llvm_cov_runner::publish_derived::batch_derived_index_check_aggregate_support::check_aggregate_entries_fingerprint;
pub use crate::rust_llvm_cov_runner::publish_derived::batch_derived_index_check_aggregate_support::is_check_aggregate_population;
...
pub struct RustPopulationState {
    ...
    pub test_binaries: BTreeMap<String, crate::rust_llvm_cov_runner::RustTestBinaryIdentity>,
}
...
fn index_matches_derived_entries(
    ...
    crate::rust_llvm_cov_runner::publish_derived::batch_derived::derived_generation_line_index(
        cache_root,
        source_root,
...
fn manifest_generation_entries_complete(
    ...
    if let Some(reverse) = manifest.reverse_line_index.as_ref() {
        ...
        return crate::rust_llvm_cov_runner::publish_derived::batch_entry_state::entry_state_matches(
            &state,
            &manifest.generation_fingerprint,
...
pub fn reusable_snapshot_delta(
    ...
    crate::rust_llvm_cov_runner::publish_derived::batch_derived_snapshot::reusable_snapshot_delta(
        source_root,
        prior,
        current,
    )
...
pub(crate) use crate::rust_llvm_cov_runner::rust_cov_cache::normalized_source_root;
