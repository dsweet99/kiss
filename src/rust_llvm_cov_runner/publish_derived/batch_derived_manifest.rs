...
use crate::rust_llvm_cov_runner::rust_cov_cache::rust_cov_unique_suffix;
use crate::rust_llvm_cov_runner::{CACHE_SCHEMA_VERSION, RustLlvmCovError, RustTestBinaryIdentity};
...
pub(crate) fn write_population_manifest(
    ...
    for attempt in 0..2 {
        ...
        match crate::kiss_publication_barrier::publish_atomically(
            "rust_population",
            &path,
            &attempt_tmp,
            |file| {
...
pub(crate) fn write_population_and_durations(
    ...
    crate::rust_llvm_cov_runner::publish_derived::batch_population_durations::try_publish_durations_after_population(
        &req.cache_root,
        identity,
        req,
        tools,
