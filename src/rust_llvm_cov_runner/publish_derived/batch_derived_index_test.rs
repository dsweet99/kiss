...
fn index_type_validators_reject_unsorted_invalid_paths_and_binaries() {
    ...
    assert!(
        crate::rust_llvm_cov_runner::publish_derived::batch_derived_index_types::validate_ordinary_source_digests(vec![
    ...
    assert!(
        crate::rust_llvm_cov_runner::publish_derived::batch_derived_index_types::validate_test_binaries(vec![
            TestBinaryRecord {
                id: String::new(),
