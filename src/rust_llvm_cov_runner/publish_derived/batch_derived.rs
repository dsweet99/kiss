...
pub fn publish_derived_state_with_binaries(
    ...
    crate::rust_llvm_cov_runner::publish_derived::batch_derived_index_write::write_coverage_index(
        &req.cache_root,
        &req.source_root,
        &identity.generation_fingerprint,
        &entries_fingerprint,
    ...
    crate::rust_llvm_cov_runner::publish_derived::batch_derived_manifest::write_population_and_durations(
        req,
        tools,
        identity,
        selectors,
    ...
    let reverse_snapshots_reclaimed =
        match crate::rust_llvm_cov_runner::publish_derived::batch_reverse_line_index::prune_unreferenced_snapshots(
            &req.cache_root,
            &reverse.snapshot_id,
...
pub fn publish_conservative_derived_state_from_check_aggregate(
    ...
    let entries_fingerprint =
        crate::rust_llvm_cov_runner::publish_derived::batch_derived_index::check_aggregate_entries_fingerprint(aggregate);
    crate::rust_llvm_cov_runner::publish_derived::batch_derived_index_write::write_coverage_index(
        &req.cache_root,
        &req.source_root,
        &identity.generation_fingerprint,
