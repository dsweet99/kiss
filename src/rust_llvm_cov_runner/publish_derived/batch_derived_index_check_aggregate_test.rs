use crate::rust_llvm_cov_runner::publish_derived::batch_derived::publish_conservative_derived_state_from_check_aggregate;
...
fn load_check_aggregate_population_skips_index_json_body() {
    ...
    std::fs::write(
        ...
        format!(
            ...
            crate::rust_llvm_cov_runner::publish_derived::batch_derived::INDEX_SCHEMA_VERSION,
