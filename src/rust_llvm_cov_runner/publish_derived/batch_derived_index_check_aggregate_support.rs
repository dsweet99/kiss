...
pub(crate) fn check_aggregate_entries_fingerprint(
    aggregate: &crate::rust_llvm_cov_runner::publish_derived::batch_check_aggregate::ValidatedCheckAggregate,
) -> String {
    format!(
...
pub(crate) fn load_check_aggregate_population_state(
    ...
    let aggregate = match &mode {
        PopulationLoadMode::Current { .. } => {
            crate::rust_llvm_cov_runner::publish_derived::batch_check_aggregate::load_current_check_aggregate_snapshot(
                cache_root,
                source_root,
                &identity,
        ...
        } => crate::rust_llvm_cov_runner::publish_derived::batch_check_aggregate::load_reusable_prior_check_aggregate(
            cache_root,
            source_root,
            &manifest.selectors,
            selection_context_fingerprint,
