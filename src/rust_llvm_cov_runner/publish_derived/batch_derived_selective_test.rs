...
fn assert_success_prune_removes_obsolete(
    ...
    let mut succeeded = crate::rust_llvm_cov_runner::RustCoverageBatchResult {
        completed: Vec::new(),
        counters: crate::rust_llvm_cov_runner::RustCoverageBatchCounters::default(),
        batch_error: None,
        test_binaries: Vec::new(),
...
fn rewrite_lib_store_selective_and_prune(
    ...
    let pruned = crate::rust_llvm_cov_runner::publish_derived::batch_derived::prune_obsolete_selective_generations(
        &req.cache_root,
        &selective_identity.generation_fingerprint,
    )
    .unwrap();
