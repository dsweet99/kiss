...
fn reverse_index_answers_overlapping_symbol_lines() {
    ...
    let hit = crate::rust_llvm_cov_runner::query_reverse_line_index(
        &cache,
        "gen1",
    ...
    let miss = crate::rust_llvm_cov_runner::query_reverse_line_index(
        &cache,
        "gen1",
...
fn reverse_index_answers_multi_range_selector_coverage() {
    ...
    let both = crate::rust_llvm_cov_runner::query_reverse_line_index(
        &cache,
        "gen1",
        &BTreeMap::from([("src/lib.rs".into(), BTreeSet::from([1_u32, 4_u32]))]),
    )
    ...
    let gap = crate::rust_llvm_cov_runner::query_reverse_line_index(
        &cache,
        "gen1",
        &BTreeMap::from([("src/lib.rs".into(), BTreeSet::from([3_u32]))]),
    )
...
fn reverse_index_rejects_other_generation() {
    ...
    assert!(
        crate::rust_llvm_cov_runner::query_reverse_line_index(
            &cache,
            "gen2",
            &BTreeMap::from([("src/lib.rs".into(), BTreeSet::from([1_u32]))]),
        )
