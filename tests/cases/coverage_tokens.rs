...
const COVERAGE_TOKENS: &[&str] = &[
    ...
    "src/test_refs/coverage.rs::module_definition_counts",
    "src/test_refs/coverage_import_cal.rs::module_has_usage_witness",
    "src/test_refs/coverage_import_cal.rs::module_is_contrib_base_void",
    "src/test_refs/coverage_import_cal.rs::import_calibration_def_cap",
    "src/test_refs/coverage_import_cal.rs::import_cal_dep_qualifies",
    "src/test_refs/coverage_import_cal.rs::apply_import_dependency_calibration",
    "src/test_refs/collect.rs::is_py_oi_protocol_stub_path",
    "src/test_refs/collect_imports.rs::call_tail_name",
    "src/test_refs/collect_imports.rs::collect_raises_type_args",
    "src/test_refs/collect_imports.rs::first_positional_identifier",
    "src/test_refs/coverage.rs::is_py_oi_module_import_target_file",
    "src/test_refs/coverage_expand_paths.rs::path_normal_components",
    "src/test_refs/coverage_expand_paths.rs::is_py_repo_root_subtree",
    "src/rust_test_refs/calibration_map_paths.rs::path_normal_components",
    "src/rust_test_refs/calibration_map_paths.rs::workspace_crates_dir",
    "src/rust_test_refs/calibration_map_paths.rs::workspace_crates_sibling_count",
    "src/test_refs/calibration_analysis.rs::void_partition_covered",
    "src/test_refs/calibration_analysis.rs::inflator_call_only_uncovered",
    "src/test_refs/calibration_analysis.rs::ops_hub_class_deny",
    "src/test_refs/calibration_analysis.rs::bound_tier_covered",
    "src/test_refs/calibration_analysis.rs::experiments_path_covered",
    "src/test_refs/calibration_analysis.rs::rl_or_oi_path_covered",
    "src/test_refs/calibration_analysis.rs::shipped_calibration_refs",
    "src/test_refs/calibration_analysis.rs::shipped_calibration_covered",
    "src/test_refs/calibration_analysis.rs::calibration_def_covered",
    "src/test_refs/calibration_analysis.rs::definition_is_covered",
    "src/test_refs/mod.rs::analyze_test_refs_for_coverage_map_with_bound",
    "src/test_refs/mod.rs::FilterUnreferencedInputs",
    "src/test_refs/mod.rs::filter_unreferenced_for_analysis",
    "ops/cd_cli.py::main",
...
pub fn run_touch_kiss_check_coverage_gates() {
